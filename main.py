...
o('The day 1')
o('叮铃铃, 起床铃在你耳边响起...你周围的舍友都起来了, 但是现在是 7:00 AM, 距离跑操铃响起还有15分钟.')
while True: #第一天 - 早上
    ...
    if get_up_or_sleep == '1': #刷牙发现不能刷
        ...
        print('\n---------------------')
        o('第一章 第一幕: 早晨 - 起床 [已完成] '+'你目前的积分: ' + str(point))
        print('---------------------\n')
        ...
        while True: 
            ...
            #循环结束
            print('\n---------------------')
            o('第一章 第二幕: 早晨 - 跑操 [已完成] '+'你目前的积分: ' + str(point))
            print('---------------------\n')
            break
...
while True:
    ...
    if buy8_5_or4_5 == '1':
        ...
        print('\n---------------------')
        o('第二章 第一幕: 中午 - 午餐 [已完成] '+'你目前的积分: ' + str(point)) #day 1
        print('---------------------\n')
        ...
        while True:
            ...
            if use_money_or_bring == '1': #独吞 50 元
                ...
                print('\n---------------------')
                o('第二章 第二幕: 中午&晚上 - 50 元钱 [已完成] '+'你目前的积分: ' + str(point))
                print('---------------------\n')
                break
    ...
    if buy8_5_or4_5 == '2': #买 4.5的饭
        ...
        print('\n---------------------')
        o('第二章 第一幕: 中午 - 午/晚餐 [已完成] '+'你目前的积分: ' + str(point)) #day 1
        print('---------------------\n')
